    ...
    public function __invoke(string $hashedKey, User|AvatarUser $user)
    {
        ...
        $formConfigs = [
            ...
            'classIIAntigens' => [
                ...
                ['name' => 'drb31', 'label' => 'drb3*', 'group' => 1],
                ['name' => 'drb32', 'label' => 'drb3*', 'group' => 1],
                ['name' => 'drb41', 'label' => 'drb4*', 'group' => 1],
                ['name' => 'drb42', 'label' => 'drb4*', 'group' => 1],
                ['name' => 'drb51', 'label' => 'drb5*', 'group' => 1],
                ['name' => 'drb52', 'label' => 'drb5*', 'group' => 1],
                ['name' => 'dqb11', 'label' => 'dqb1*', 'group' => 1],
                ['name' => 'dqb12', 'label' => 'dqb1*', 'group' => 1],
            ],
            'additionAntigens' => [
