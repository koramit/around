...
class CaseRecordCompleteAction extends KidneyTransplantAdmissionAction
{
    ...
    protected function validateAdmitForTransplant(array &$data, KidneyTransplantAdmissionCaseRecord $caseRecord): array
    {
        ...
        return Validator::validate($data, [
            ...
            'donor_creatinine_before_harvest' => ['required', 'numeric', 'min:0'],
            'immunosuppressive_drugs_induction' => ['array'],
            'immunosuppressive_drugs_induction.none' => ['boolean', new AcceptedIfOthersFalsy($data['immunosuppressive_drugs_induction'])],
            'immunosuppressive_drugs_induction.simulect' => ['boolean'],
            'immunosuppressive_drugs_induction.ATG' => ['boolean'],
            'immunosuppressive_drugs_induction.rituximab' => ['boolean'],
            'immunosuppressive_drugs_induction.induction_other' => ['nullable', 'string', 'max:255'],
            ...
            'creatinine_at_discharge' => ['required', 'numeric', 'min:0'],
