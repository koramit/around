...
class PrintCaseFrontCover
{
    ...
    public function __invoke(string $hashedKey, User|AvatarUser $user): array
    {
        ...
        $data['last_pra_class_i_percent'] = is_null($case->form['last_pra_class_i_percent'])
            ? null
            : $case->form['last_pra_class_i_percent'] . '%';
        $data['last_pra_class_ii_percent'] = is_null($case->form['last_pra_class_ii_percent'])
            ? null
        ...
        $data['peak_pra_class_i_percent'] = is_null($case->form['peak_pra_class_i_percent'])
            ? null
            : $case->form['peak_pra_class_i_percent'] . '%';
        $data['peak_pra_class_ii_percent'] = is_null($case->form['peak_pra_class_ii_percent'])
            ? null
