...
class CaseUpdateAction extends CaseBaseAction
{
    public function __invoke(string $hashedKey, array $data, User|AvatarUser $user): array
    {
        ...
        $validated = Validator::validate($data, [
            ...
            'induction' => ['nullable', 'in:ATG,L2 RA - Basiliximab,NO'],
            'atg_dose_mg' => ['nullable', 'numeric'],
            'atg_duration_days' => ['nullable', 'integer', 'min:1'],
            ...
            'date_update_graft_status' => ['required', 'date', 'before:tomorrow', 'after_or_equal:date_transplant'],
            'date_graft_loss' => ['nullable', 'date', 'after_or_equal:date_transplant'],
            ...
            'date_dead' => ['nullable', 'date', 'after_or_equal:date_transplant'],
