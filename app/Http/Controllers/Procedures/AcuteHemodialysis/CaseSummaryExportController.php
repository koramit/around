...
use App\Actions\Procedures\AcuteHemodialysis\SummaryCases;
...
class CaseSummaryExportController
{
    /**
     * @throws IOException
     ...
     */
    public function __invoke(Request $request, SummaryCases $action)
    {
        $data = $action(
