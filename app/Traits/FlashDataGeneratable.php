    ...
    protected function getFlash(string $title, User $user): array
    {
        return [
            ...
            'main-menu-links' => collect([
                ...
                ['icon' => 'clipboard-medical', 'label' => 'Clinics', 'route' => route('clinics.index'), 'can' => true],
                /*['icon' => 'clipboard-medical', 'label' => 'Clinics', 'route' => route('clinics.index'), 'can' => $this->getRoutesByRegistryTypeAndUser('clinics', $user)->count()],*/
