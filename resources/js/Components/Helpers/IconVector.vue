<template>
    ...
    >
        ...
        /></svg>
        <svg
            v-else-if="name === 'arrow-circle-left'"
            viewBox="0 0 512 512"
        ><path
            fill="currentColor"
